...
function getPriceForTPair(tPair, pricesJson) {
    ...
    var pair_a_ask = pricesJson[pair_a]
        ? parseFloat(pricesJson[pair_a]["lowestAsk"])
        : 0;
    var pair_a_bid = pricesJson[pair_a]
        ? parseFloat(pricesJson[pair_a]["highestBid"])
        : 0;
    var pair_b_ask = pricesJson[pair_b]
        ? parseFloat(pricesJson[pair_b]["lowestAsk"])
        : 0;
    var pair_b_bid = pricesJson[pair_b]
        ? parseFloat(pricesJson[pair_b]["highestBid"])
        : 0;
    var pair_c_ask = pricesJson[pair_c]
        ? parseFloat(pricesJson[pair_c]["lowestAsk"])
        : 0;
    var pair_c_bid = pricesJson[pair_c]
